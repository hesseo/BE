    ...
    public SecurityFilterChain configure(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorizeRequests ->authorizeRequests
                        ...
                        .requestMatchers("/api/members/reissue","/api/members/signUp","/api/members/login","/api/members/findId", "/api/members/checkId",
                                "/api/members/emails/**", "/api/oauth/token",
                                "/api/cite/**",
                                "/api/paraphrase/**", "/api/summary/**", "/oauth2/**").permitAll()
